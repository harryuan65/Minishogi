...
/*	attack	*/
#define w_king_attack(pos)       (king_move[pos]     & board.b_occupied)
#define w_gold_attack(pos)       (w_gold_move[pos]   & board.b_occupied)
#define w_silver_attack(pos)     (w_silver_move[pos] & board.b_occupied)
#define w_pawn_attack(pos)       (w_pawn_move[pos]   & board.b_occupied)
#define w_bishop_attack(pos)     (BishopMove(board, pos, WHITE) & board.b_occupied)
#define w_rook_attack(pos)	     (RookMove(board, pos, WHITE)   & board.b_occupied)
#define w_e_silver_attack(pos)   (w_gold_move[pos]   & board.b_occupied)
#define w_e_pawn_attack(pos)     (w_gold_move[pos]   & board.b_occupied)
#define w_e_bishop_attack(pos)   ((BishopMove(board, pos, WHITE) | king_move[pos]) & board.b_occupied)
#define w_e_rook_attack(pos)	 ((RookMove(board, pos, WHITE)   | king_move[pos]) & board.b_occupied)
#define b_king_attack(pos)       (king_move[pos]     & board.w_occupied)
#define b_gold_attack(pos)       (b_gold_move[pos]   & board.w_occupied)
#define b_silver_attack(pos)     (b_silver_move[pos] & board.w_occupied)
#define b_pawn_attack(pos)       (b_pawn_move[pos]   & board.w_occupied)
#define b_bishop_attack(pos)     (BishopMove(board, pos, BLACK) & board.w_occupied)
#define b_rook_attack(pos)       (RookMove(board, pos, BLACK)   & board.w_occupied)
#define b_e_silver_attack(pos)   (b_gold_move[pos]   & board.w_occupied)
#define b_e_pawn_attack(pos)     (b_gold_move[pos]   & board.w_occupied)
